class GalleriesController < ApplicationController
  ...
  before_action :sanitize_images_params, only: %i[ create update ]
  ...
  private
    ...
    def gallery_params
      params.expect(gallery: [ :name, {images: []} ])
    end

    def sanitize_images_params
      return unless params.dig('gallery', 'images').is_a?(Array)
    
      params['gallery']['images'].compact_blank!
    end
